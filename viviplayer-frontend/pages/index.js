...
import { Form, Input, Tabs, Button, Checkbox, notification, Col, Row, Layout } from 'antd';
            ...
            <div className="content">
              <Tabs defaultActiveKey="1" onChange={callback}>
                <TabPane tab="Login with TAN" key="1">
                  <Form name="TAN Login" onFinish={loginWithTan} autoComplete="off" {...layoutFormTan}>
                ...
                <TabPane tab="Login as Moderator" key="2">
                  ...
                  >
                    ...
                    <Form.Item {...layoutButton}>
                      <Button type="primary" htmlType="submit" {...layoutButton}>
                        Submit
                      </Button>
                    </Form.Item>
                  </Form>
