\section{Qualitätsanforderungen}
    ...
    \linebreak
    Im Hinblick auf die Zuverlässigkeit, da die Software im Live-Umfeld eingesetzt wird, ist es sehr wichtig, dass die Software möglichst fehlerfrei ist und im Fehlerfall nicht zu Problemen bei anderen Benutzern führt.
    \linebreak
	...
	\linebreak
	Die Wartbarkeit der Software wird durch die Verwendung einer einheitlichen Code Konvention sowie durc gut kommentierten Code und die Reduzierung der Codekomplexität gewährleistet.
	\linebreak
